package com.sms.ok.module.infra.service.codegen.inner;
...
import com.sms.ok.framework.apilog.core.enums.OperateTypeEnum;
import com.sms.ok.framework.common.exception.util.ServiceExceptionUtil;
...
import com.sms.ok.framework.common.util.object.ObjectUtils;
import com.sms.ok.framework.common.util.string.StrUtils;
import com.sms.ok.framework.excel.core.annotations.DictFormat;
import com.sms.ok.framework.excel.core.convert.DictConvert;
import com.sms.ok.framework.excel.core.util.ExcelUtils;
import com.sms.ok.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.sms.ok.module.infra.framework.rpc.config.RpcConfiguration",
