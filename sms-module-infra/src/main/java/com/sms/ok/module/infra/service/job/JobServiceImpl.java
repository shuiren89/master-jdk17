package com.sms.ok.module.infra.service.job;

import cn.hutool.extra.spring.SpringUtil;
import com.sms.ok.framework.common.pojo.PageResult;
import com.sms.ok.framework.common.util.object.BeanUtils;
import com.sms.ok.framework.quartz.core.handler.JobHandler;
import com.sms.ok.framework.quartz.core.scheduler.SchedulerManager;
import com.sms.ok.framework.quartz.core.util.CronUtils;
import com.sms.ok.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import com.sms.ok.module.infra.controller.admin.job.vo.job.JobSaveReqVO;
import com.sms.ok.module.infra.dal.dataobject.job.JobDO;
import com.sms.ok.module.infra.dal.mysql.job.JobMapper;
import com.sms.ok.module.infra.enums.job.JobStatusEnum;
...
import static com.sms.ok.framework.common.util.collection.CollectionUtils.containsAny;
