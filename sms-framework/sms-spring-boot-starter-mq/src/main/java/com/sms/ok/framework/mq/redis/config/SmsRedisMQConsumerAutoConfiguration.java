...
import com.sms.ok.framework.common.enums.DocumentEnum;
import com.sms.ok.framework.mq.redis.core.RedisMQTemplate;
import com.sms.ok.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.sms.ok.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.sms.ok.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.sms.ok.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class SmsRedisMQConsumerAutoConfiguration {
