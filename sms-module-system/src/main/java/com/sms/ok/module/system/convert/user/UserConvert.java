package com.sms.ok.module.system.convert.user;

import com.sms.ok.framework.common.util.collection.CollectionUtils;
import com.sms.ok.framework.common.util.collection.MapUtils;
import com.sms.ok.framework.common.util.object.BeanUtils;
import com.sms.ok.module.system.controller.admin.dept.vo.dept.DeptSimpleRespVO;
import com.sms.ok.module.system.controller.admin.dept.vo.post.PostSimpleRespVO;
import com.sms.ok.module.system.controller.admin.permission.vo.role.RoleSimpleRespVO;
import com.sms.ok.module.system.controller.admin.user.vo.profile.UserProfileRespVO;
import com.sms.ok.module.system.controller.admin.user.vo.user.UserRespVO;
import com.sms.ok.module.system.controller.admin.user.vo.user.UserSimpleRespVO;
