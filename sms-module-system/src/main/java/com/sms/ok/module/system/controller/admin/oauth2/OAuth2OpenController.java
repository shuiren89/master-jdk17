package com.sms.ok.module.system.controller.admin.oauth2;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.sms.ok.framework.common.enums.UserTypeEnum;
import com.sms.ok.framework.common.pojo.CommonResult;
import com.sms.ok.framework.common.util.http.HttpUtils;
import com.sms.ok.framework.common.util.json.JsonUtils;
import com.sms.ok.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.sms.ok.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.sms.ok.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.sms.ok.module.system.convert.oauth2.OAuth2OpenConvert;
import com.sms.ok.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.sms.ok.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.sms.ok.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.sms.ok.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.sms.ok.module.system.service.oauth2.OAuth2ApproveService;
import com.sms.ok.module.system.service.oauth2.OAuth2ClientService;
import com.sms.ok.module.system.service.oauth2.OAuth2GrantService;
import com.sms.ok.module.system.service.oauth2.OAuth2TokenService;
import com.sms.ok.module.system.util.oauth2.OAuth2Utils;
...
import static com.sms.ok.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.sms.ok.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
import static com.sms.ok.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
