package com.sms.ok.module.system.service.tenant;
...
import com.sms.ok.framework.common.util.date.DateUtils;
import com.sms.ok.framework.common.util.object.BeanUtils;
import com.sms.ok.framework.datapermission.core.annotation.DataPermission;
import com.sms.ok.framework.tenant.config.TenantProperties;
import com.sms.ok.framework.tenant.core.context.TenantContextHolder;
import com.sms.ok.framework.tenant.core.util.TenantUtils;
import com.sms.ok.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.sms.ok.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.sms.ok.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.sms.ok.module.system.convert.tenant.TenantConvert;
import com.sms.ok.module.system.dal.dataobject.permission.MenuDO;
import com.sms.ok.module.system.dal.dataobject.permission.RoleDO;
import com.sms.ok.module.system.dal.dataobject.tenant.TenantDO;
import com.sms.ok.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.sms.ok.module.system.dal.mysql.tenant.TenantMapper;
import com.sms.ok.module.system.enums.permission.RoleCodeEnum;
import com.sms.ok.module.system.enums.permission.RoleTypeEnum;
import com.sms.ok.module.system.service.permission.MenuService;
import com.sms.ok.module.system.service.permission.PermissionService;
import com.sms.ok.module.system.service.permission.RoleService;
import com.sms.ok.module.system.service.tenant.handler.TenantInfoHandler;
import com.sms.ok.module.system.service.tenant.handler.TenantMenuHandler;
