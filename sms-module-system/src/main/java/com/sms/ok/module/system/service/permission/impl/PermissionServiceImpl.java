...
import com.sms.ok.module.system.dal.dataobject.permission.RoleMenuDO;
import com.sms.ok.module.system.dal.dataobject.permission.UserRoleDO;
import com.sms.ok.module.system.dal.mysql.permission.RoleMenuMapper;
import com.sms.ok.module.system.dal.mysql.permission.UserRoleMapper;
import com.sms.ok.module.system.dal.redis.RedisKeyConstants;
import com.sms.ok.module.system.enums.permission.DataScopeEnum;
import com.sms.ok.module.system.service.dept.DeptService;
import com.sms.ok.module.system.service.permission.*;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Resource
    private DeptDataPermissionService deptDataPermissionService;
    @Lazy
    @Resource
    private UserDeptInfoService userDeptInfoService;
    ...
    public DeptDataPermissionRespDTO getDeptDataPermission(Long userId) {
        ...
        // 使用新的服务计算部门数据权限
        return deptDataPermissionService.calculateDeptDataPermission(userId, roles, userDeptId);
    }

    /**
     * 获取用户部门ID
     * 使用 @Lazy 注入的 UserDeptInfoService 来避免循环依赖
     */
    private Long getUserDeptId(Long userId) {
        return userDeptInfoService.getUserDeptId(userId);
    }
